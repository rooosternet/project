module DevisePermittedParameters
  ...
  def configure_permitted_parameters
    ...
    devise_parameter_sanitizer.for(:account_update) << [:id,:terms_of_service,:subscribe,:edit_profile,:name,:email,:email2,:firstname,:lastname, profile_attributes: [:id,:is_company, :is_freelancer,:searchable,:public_email,:location,:job_title,:company_name,:company_website,:online_portfolio,:linkedin_profile,:behance,:vimeo,:social_links,:skills]]
